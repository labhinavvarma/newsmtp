...
DEFAULT_CONFIG_PATH = os.environ.get('CONFIG_PATH', '/smtp_server/smtp_config.json')
...
DEFAULT_CONFIG = {
    ...
    "smtp_port": 587,
    "use_tls": True,
    "email": "raomadhav653@gmail.com",  # Empty by default for security
    "password": "fxux rpsu qlzz bxpl"  # Empty by default for security
}
